defmodule ProjeXpertWeb.CoreComponents do
  @moduledoc """
  ...
  def text_editor(assigns) do
    ...
    <div class={@class}>
      ...
      >
        <trix-editor input={@id} class="trix-editor"></trix-editor>
      </div>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ProjeXpertWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ProjeXpertWeb.Gettext, "errors", msg, opts)
    end
  end
